...
def build_signature(tpfy_model):
    ...
    output_dict = {}
    for obj in ["click", "click_recab", "watch", "paywall_view", "add_watchlist"]:
        output_dict[obj] = build_tensor_info(compact_predict_output[obj])
...
def export_tpfy_model(
    ...
    predict_inputs, predict_output, predict_signature = build_signature(tpfy_model)
    signature_def_map = {
