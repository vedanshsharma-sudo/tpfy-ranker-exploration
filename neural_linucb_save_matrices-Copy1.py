...
from tpfy.train_v3_mtl import make_example_mtl, TpfyConfig
from tpfy.helper import load_model_weights_from_s3
from common.s3_utils import upload_file, upload_folder
...
def compute_A_b(A, b, next_batch, last_layer_tensor, session):
    ...
    # activation_values, labels, _ = get_activations_and_labels(next_batch, last_layer_tensor)
