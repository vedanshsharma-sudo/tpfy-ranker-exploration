...
def run():
    ...
    def validation(iterator, model, last_layer_tensor, d=128, runs=10):
        ...
        # Clean up lists
        del all_predictions, all_labels, all_variances
        
        return predictions, labels, variances, all_content_ids, mse_sum / valid_runs
    ...
    while True:
        try:
            if (run % 100 == 0) and (run):
                ...
                predictions, labels, variances, content_ids, val_mse = val_results
